...
public class Encoder {
	...
	// to make a Reed-Solomon code, you take the input message, then divide it by
	// the irreducible polynomial, this quotient is the appended onto the original
	// message
	public int[] encodeMessage(int[] inputMessage, int numSymbols) {

		if (inputMessage.length + numSymbols > 255) {
			System.out.println("The input was too big. It was: " + (inputMessage.length + numSymbols)
					+ "big, and only data sizes up to 255 are supported. Exiting.");
			System.exit(0);
		}
