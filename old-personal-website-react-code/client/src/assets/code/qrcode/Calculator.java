...
public class Calculator {
	...
	public static int[] generateGenerator(int numSymbols) {
		...
		// Generate the irreducible polynomial over the Finite Field that is required
		// for RS encoding
	...
	// This is term by term polynomial addition. With us, it is bit by bit XOR for
	// GF(2)
	...
	// Evaluates a polynomial at a certain x value - Horner's method for
	// optimization
	...
	// Divides two polynomials using a method called Extended Synthetic division -
	// faster than long division
	// Opposed to the other functions here, the coefficients of Calculator are kept
	// in a list backwards than the others
	// 1 + 2x + 5x^5 is [5, 2, 1] not [1, 2, 5] like it would be in the other
	// functions
	...
	// A function to divide numbers without carrying, without the Galois Field in
	// terms of 2^8
